    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                            ...
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class="huge"><img src="${pageContext.request.contextPath}/bootstrap/users_clients_group_16774.png" width="100" height="100"/></div>
                        ...
                        <div class="panel panel-green">
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class="huge"><img src="${pageContext.request.contextPath}/bootstrap/system-user-man-icon.png" width="100" height="100"/></div>
                            ...
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        ...
                                        <div > <img src="${pageContext.request.contextPath}/bootstrap/book-305126_960_720.png" width="100" height="100"/></div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                      <a href="${pageContext.request.contextPath}/bootstrap/empresa.jsp">  
                                          <div class="huge"><img src="${pageContext.request.contextPath}/bootstrap/condominio.png" width="100" height="100"/></div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                       <img src="${pageContext.request.contextPath}/bootstrap/livro.png" width="40%" height="20%"/>
                      <img src="${pageContext.request.contextPath}/bootstrap/book2.png" left="90%" width="40%" height="20%"/>
                    </div>
                </div>
                <!-- /.row -->
